...
# print PROJECT_DIR
# print os.path.join(PROJECT_DIR, 'log/django.log')

ALLOWED_HOSTS = '*'

ADMINS = (
    # ('Your Name', 'your_email@example.com'),
    ('jacky', 'JackyShen@ScrumChina.com')
)
...
SECRET_KEY = 'z0hu8g#p0fdaf024lr9xmpx_end$4bm!123t@!)!s^fpht$@z-'
...
LOGGING = {
    ...
    'loggers': {
        'django.request': {
            'handlers': ['custom_log_file'],  # 'mail_admins',
            'level': 'ERROR',
            'propagate': True,
        },
        # 'django': {
...
# ###################
QINIU_ACCESS_KEY = 'JKxFRXD_jfl5AKMp8XOETKkYu599IokW3D6GPS-8'
QINIU_SECRET_KEY = 'LYYg0Usg15GZoaNNhzI9lB2_yMy1mYfAR0O6tcf9'
QINIU_BUCKET_DEFAULT = 'app-17sports'
